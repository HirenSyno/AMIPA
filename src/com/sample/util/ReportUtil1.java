...
public class ReportUtil1 {
	public static  String currentTestName1 = null;
	public static String TEST_SUITE_SHEET = null;
	...
	public static List <Date> startDateList = new ArrayList<Date>();
	public static List <Date> endDateList = new ArrayList<Date>();
	public static String currentTestSuite=null;
	public static String totalpass= null;
	public static String totalfail= null;
	...
	public boolean generateReport()throws Exception 
	{
		...
		String module=CONFIG.getProperty("module");
		String buildNumber=CONFIG.getProperty("buildNumber");
		...
		String indexHtmlPath=report_FolderName+"\\index.html";
		...
		try{
			...
			out.write("<html><HEAD> <TITLE>Automation Test Results</TITLE></HEAD><body><h4 align=center><FONT COLOR=660066 FACE=AriaL SIZE=6><b><u> Automation Test Results</u></b></h4><table  border=1 cellspacing=1 cellpadding=1 ><tr><h4> <FONT COLOR=660000 FACE=Arial SIZE=4.5> <u>Test Details :</u></h4><td width=150 align=left bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Execution Start Date&Time</b></td><td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>");
			out.write(startDate.toString());
			
			
			
			//out.write("</b></td></tr><tr><td width=150 align=left bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Execution Start Date & Time</b></td><td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>");
		
			
			out.write("</b></td></tr><tr><td width=150 align=left bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Execution End Date & Time</b></td><td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>");
			...
			out.write("</b></td></tr><tr><td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>module</b></td><td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>");
			out.write(module);
			
			out.write("</b></td></tr><tr><td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>branch</b></td><td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>");
			out.write(branch);
			
			out.write("</b></td></tr><tr><td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>buildNumber</b></td><td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>");
			...
			for(int currentSuiteID =2;currentSuiteID<= totalTestSuites;currentSuiteID++)
			{
				...
				for(int currentTestCaseID=2;currentTestCaseID<=current_suite_xls.getRowCount(Constants.TEST_CASES_SHEET);currentTestCaseID++)
				{
					...
					testSteps_file=report_FolderName+"\\"+currentTestSuite+"_steps.html";
					...
					FileWriter fstream_test_steps= new FileWriter(report_FolderName+"\\"+testcaseFilePath+".html");
		...
		//SendMail.execute(reportFileName);
		
	}
	
	public BufferedWriter addStartEndDate(BufferedWriter out, int initDateCount, int finalDateCount) throws IOException{
		
		if (initDateCount <= finalDateCount) {
			
					out.write("<td align= left bgcolor=#ffffff><FONT COLOR=#000000 FACE= Arial  SIZE=1>");
			out.write(startDateList.get(
					initDateCount).toString());
			out
					.write("<td align= left bgcolor=#ffffff><FONT COLOR=#000000 FACE= Arial  SIZE=1>");
			out.write(endDateList.get(
					initDateCount).toString());
		}
		out.write("</tr>");
		return out;
