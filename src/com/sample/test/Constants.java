...
public class Constants {
	...
	public static final String COMPONENT = null;
	public static String TC_STATUS = "Status";
	public static final String PDF_FOLDER_PATH = System.getProperty("user.dir") + File.separator + "src" + File.separator + "files" + File.separator + "medical_doc.pdf";
	public static final String IMAGE_FOLDER_PATH = System.getProperty("user.dir") + File.separator + "src" + File.separator + "files" + File.separator + "profile.png";
	//public static final String IMAGE_FOLDER_PATH = System.getProperty("user.dir") + "src" + "files" + "profile.png";
}
