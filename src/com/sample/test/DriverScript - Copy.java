...
public class DriverScript {
	...
	public static void main(String[] args) throws Exception {
		...
		ReportUtil1 report1=new ReportUtil1();
		...
		//String env,String branch,String module,String browser,String jobID,String emailDeliver,String to_email
 		//sendmail.execute(project,"config",module,browser,"1","Yes","testautomationever@gmail.com","sachin.vora@synoverge.com");
 		//sendmail.execute(project,"config",module,browser,"1","Yes","testautomationever@gmail.com","timir.trivedi@synoverge.com");
 		sendmail.execute(project,"config",module,browser,"1","Yes","testautomationever@gmail.com");

 		//sendmail.startExecute(project,module,browser,"1");
	...
	public void start() throws Exception {
		...
		for (currentSuiteID = 2; currentSuiteID <= suiteXLS.getRowCount(Constants.TEST_SUITE_SHEET); currentSuiteID++) 
		{
			...
			String source_path = (System.getProperty("user.dir") + "//src//com//sample//xls//" + currentTestSuite
					+ ".xlsx").toString();
			dest_path = (System.getProperty("user.dir") + "//src//com//sample//xls//" + currentTestSuite
									+ "_" + timeStamp + ".xlsx").toString();
			
			hmap.put(currentSuiteID, dest_path);
			
			File source = new File(source_path);
			File target = new File(dest_path);
			...
			currentTestSuiteXLS=new Xls_Reader(dest_path);
			...
			if (suiteXLS.getCellData(Constants.TEST_SUITE_SHEET, Constants.RUNMODE, currentSuiteID)
				...
				//currentTestSuiteXLS=new Xls_Reader(System.getProperty("user.dir")+"//src//com//sample//config//"+currentTestSuite+".xlsx");
				
				/*String timeStamp = getTimeStamp();
				String source_path = (System.getProperty("user.dir") + "//src//com//sample//config//" + currentTestSuite
						+ ".xlsx").toString();
				dest_path = (System.getProperty("user.dir") + "//src//com//sample//config//" + currentTestSuite
										+ "_" + timeStamp + ".xlsx").toString();
				hmap.put(currentSuiteID, dest_path);
				...
				String dest_path = (System.getProperty("user.dir") + "//src//com//sample//config//" + currentTestSuite
						+ "_" + timeStamp + ".xlsx").toString();
...
//		SendMail sendmail=new SendMail();
//		sendmail.execute(project,"config",module,module1,browser,buildNumber,"1","Yes","testautomationever@gmail.com",hmap);
	}
		...
		for (currentTestStepID = 2; currentTestStepID <= currentTestSuiteXLS
			...
			if (currentTestCaseName.equals(
				...
				if (exectuteTestCase == true) {
					...
					try {
						orfs = new FileInputStream(System.getProperty("user.dir") + "//src//com//sample//xls//"
	...
	public void createXLSReport(String fileName) {
		try {
			String colName = Constants.RESULT + (currentTestDataSetID - 1);
			boolean isColExist = false;
			String strTemp = null;
			currentTestSuiteXLS=new Xls_Reader(fileName);
